...
namespace BusinessManager
{
    ...
    public partial class PurchaseHistoryForm : Form
    {
        ...
        {
            //SqlCeCommand cmd = new SqlCeCommand(queryString, sqlAdapterSell.SelectCommand.Connection);
            ...
            SqlCeCommand cmd = new SqlCeCommand(queryString, sqlAdapterPurchase.SelectCommand.Connection);
            SqlCeDataReader reader = cmd.ExecuteReader();
            purchaseHistoryTable.Clear();
            purchaseHistoryTable.Load(reader);
